...
This page shows some special features that come out of the box in Doctave. You can view how
...
You can read more about Mermaid JS in the [Doctave docs](https://cli.doctave.com/features/mermaid-js) or by going through the Mermaid JS
